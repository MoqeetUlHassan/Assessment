...
PostgreSQL 16, generated by the EF Core migration `Infrastructure/Data/Migrations/*_InitialSchema.cs` (plus a raw-SQL trigger). All identifiers are snake_case. This document mirrors that migration; **if they ever disagree, the migration is the truth.**
