...
|---|---|---|---|
| **Password in transit** | `PasswordFieldEncryption` ✅ (plus HTTPS) | Login and admin password payloads carry only `RSA-OAEP(nonce ‖ password)`. Nonces are single-use and expire after 2 minutes. | 400 (invalid or replayed) |
